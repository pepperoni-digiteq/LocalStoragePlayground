...
fun MainScreen(viewModel: UserViewModel) {
    ...
    val users by viewModel.allUsers.collectAsStateWithLifecycle(emptyList()) // Collect users dynamically
    ...
    Column(
        ...
        Text(text = "Register User", style = MaterialTheme.typography.headlineMedium)
...
fun UserItem(user: UserModel) {
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Text(text = "Email: ${user.passwordHash}", style = MaterialTheme.typography.bodyMedium)
        }
    }
}